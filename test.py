...
def show_cam_on_image(mask, i,j):
    # mask = F.sigmoid(mask)
...
def parse_args():
    ...
    #                     default='original_n_foggy', type=str)
    parser.add_argument('--dataset', dest='dataset',
                        help='training dataset',
...
if __name__ == '__main__':
    ...
    # loaded_dict = {k: loaded_dict[k] for k in fasterRCNN.state_dict()}
    ...
    for i in range(num_images):
        ...
        rois_label, _ = fasterRCNN(im_data, im_info, gt_boxes, num_boxes, need_backprop)
